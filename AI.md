...
## Build Process
- **Don't auto-build** — Only run `node build.js` when explicitly requested or for final verification
- User will test changes directly in browser during development
- Build creates minified dist/ folder for production deployment
